...
- Next ask Frank/ChatGPT for the next bounded product prompt. A likely next packaging batch is a deterministic workflow-run seed command through existing `/api/runs` paths, if product wants seeded generated report artifacts. Do not implement charts, live data, production auth, production reporting, generated report history, generated reports from saved workflows, Caddy, Lightsail, Cloudflare, DNS, or public deployment changes unless explicitly authorized.
