...
- Next choose whether to create a richer local viewer around restored spec sets, deepen preview/export polish after visual review, or design the future backend persistence path for briefing spec sets. Do not implement persistence, charts, Docker/Postgres, live data, or production reporting unless explicitly authorized.
