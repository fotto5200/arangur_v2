...
- Next recommended path: position-to-market-input / theme / coverage mapping design. After that, implement scenario basis contract files, one Broad Multi-Asset Basis fixture, deterministic completion, simple market-state expansion, and then the full revaluation skeleton.
