...
- Next choose whether to expose briefing-set previews in a local static viewer/index, connect local composer specs to selected view payloads, or serialize/export local spec sets. Do not implement persistence, charts, Docker/Postgres, live data, or production reporting unless explicitly authorized.
