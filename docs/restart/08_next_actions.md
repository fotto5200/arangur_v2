...
- Next choose whether to serialize/export local briefing-set specs, map saved specs onto report-element input payload selection, or design a renderer contract. Do not implement final rendering from report-element inputs unless explicitly authorized.
