...
- Next recommended path: Frank should review `docs/product/report_mockups/policy_allocation_v1/` and decide whether to keep/polish the policy allocation mockups or proceed to Policy-Level Attribution Calculation Engine v1. Keep Advisor Preview/Populate/Present wiring, generated-report integration, production/client attribution, timing attribution, scenario-versus-benchmark, probabilistic range, proposed-allocation workflows, deployment planning, and external/live data out of scope unless separately authorized.
