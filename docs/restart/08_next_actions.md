...
- Next recommended path: Frank should review `docs/product/report_mockups/policy_attribution_v1/` and decide whether to keep/polish Policy Attribution v1, proceed to a future Within-Manager Attribution Detail tranche, improve specific report-element content, or return to calculated Energy Security attribution inputs/outputs. Keep Advisor Preview/Populate/Present wiring, generated-report integration, deployment planning, production/client attribution, timing attribution, proposed-allocation workflows, and external/live data out of scope unless separately authorized.
