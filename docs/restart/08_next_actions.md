...
- Next choose whether to assemble a briefing-set preview from rendered element views, connect local composer specs to selected view payloads, or serialize/export local spec sets. Do not implement persistence, charts, Docker/Postgres, live data, or production reporting unless explicitly authorized.
