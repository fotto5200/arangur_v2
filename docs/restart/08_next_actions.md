...
- Next recommended path: Generate future synthetic Integrated Performance Attribution Summary/Detail, Manager Attribution Summary, and optionally Lens-Based Performance Attribution mockups from this prerequisite pack. Keep timing unavailable unless a later tranche defines clean timing states and trade/flow history. Keep Scenario Versus Benchmark, Probabilistic Scenario Range, Current Versus Proposed Portfolio, Advisor UI/report wiring, generated reports, and private-server deployment planning as separate later decisions.
