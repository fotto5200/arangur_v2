...
- [Integrated Performance Attribution Summary](integrated_performance_attribution_summary_mockup_v1.md)
...
- Timing Attribution (Unavailable): Unavailable unless clean history, flow treatment, and an approved timing methodology exist.
- Production Attribution Report (Gated): Gated on real benchmark, return, holding, flow data, and formal approval.
