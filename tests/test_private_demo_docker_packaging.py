...
class PrivateDemoDockerPackagingTests(unittest.TestCase):
    ...
    def test_private_demo_smoke_script_checks_local_stack_surfaces(self) -> None:
        ...
        self.assertIn("/api/briefing-templates", script)
    ...
    def test_private_demo_walkthrough_exists_and_is_linked(self) -> None:
        ...
        self.assertIn("docker compose --env-file .env.private-demo down", walkthrough)
        ...
        self.assertIn("Briefing Templates", walkthrough)
        self.assertIn("Generated Reports", walkthrough)
        self.assertIn("Generate with current data", walkthrough)
        self.assertIn("Previous/Next", walkthrough)
