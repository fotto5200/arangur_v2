    ...
    def test_root_page_returns_report_element_spec_composer(self) -> None:
        ...
        for path in ("/", "/app/", "/app/index.html"):
            with self.subTest(path=path):
                ...
                self.assertIn('id="save-workflow-button"', response.text)
                self.assertIn(">Save</button>", response.text)
                self.assertIn("Rename", response.text)
                self.assertIn("Save As New", response.text)
                self.assertIn("rename-workflow-button", response.text)
                self.assertIn("save-as-workflow-button", response.text)
                ...
                self.assertIn("Create demo populated report", response.text)
                self.assertIn("Current synthetic demo snapshot", response.text)
                self.assertIn("Open generated reports created from Populate.", response.text)
                self.assertIn("No generated reports yet. Generated reports are created from saved workflows when you populate them with demo data.", response.text)
                self.assertIn("Clear local generated reports", response.text)
                self.assertIn("LOCAL_WORKFLOW_STORAGE_KEY", response.text)
                self.assertIn("LOCAL_GENERATED_REPORT_STORAGE_KEY", response.text)
                self.assertIn("localStorage", response.text)
                self.assertIn("display_name", response.text)
                self.assertIn("workflow_id", response.text)
                self.assertIn("report_id", response.text)
                self.assertIn("storage_key", response.text)
                self.assertIn("created_at", response.text)
                self.assertIn("updated_at", response.text)
                self.assertIn("workflow_type", response.text)
                ...
                self.assertIn("workflowNameDraft", response.text)
                self.assertIn("workflowDisplayNameExists", response.text)
                self.assertIn("upsertSavedWorkflowRecord", response.text)
                self.assertIn("renameCurrentWorkflow", response.text)
                self.assertIn("saveCurrentWorkflowAsNew", response.text)
                self.assertIn("workflow_name: displayName", response.text)
                self.assertIn("Name field changes require Rename or Save As New.", response.text)
                self.assertIn("Save As New requires a unique workflow name.", response.text)
                self.assertIn("Rename requires a unique workflow name.", response.text)
                self.assertIn("Original workflow", response.text)
                ...
                self.assertIn("loadLocalGeneratedReports", response.text)
                self.assertIn("saveGeneratedReportArtifact", response.text)
                self.assertIn("normalizeGeneratedReportRecord", response.text)
                self.assertIn("renderGeneratedReports", response.text)
                self.assertIn("openGeneratedReport", response.text)
                self.assertIn("deleteGeneratedReport", response.text)
                self.assertIn("candidate.report_id === record.report_id", response.text)
                ...
                self.assertIn("Back to Home", response.text)
                self.assertIn("Back to Workflow", response.text)
                self.assertIn("Back to Reports", response.text)
                self.assertIn("Open to edit", response.text)
                self.assertIn("Create demo populated report", response.text)
                self.assertIn("Presentation view", response.text)
                self.assertIn("Generated report presentation", response.text)
                self.assertIn("Open report", response.text)
                ...
                self.assertIn('data-generated-report-action="open"', response.text)
                self.assertIn('data-generated-report-action="delete"', response.text)
                self.assertNotIn('data-workflow-action="present"', response.text)
                self.assertNotIn('data-workflow-action="open"', response.text)
                self.assertIn("Choose a generated report from Present / view reports.", response.text)
                self.assertIn("Saved in this browser for Present / view reports.", response.text)
                self.assertIn("Report type:", response.text)
                self.assertIn("Source workflow was not changed.", response.text)
                ...
                self.assertIn('ANALYTIC_VIEW_SUMMARY_ENDPOINT = "/simulation/report_element_views/report_element_analytic_view_summary.json"', response.text)
                ...
                self.assertIn("Choose a saved workflow, use the current synthetic demo data snapshot, and create a demo populated report.", populate_panel)
                self.assertIn("create a demo populated report", populate_panel.lower())
                self.assertIn("not saved to a report library", populate_panel)
                ...
                self.assertIn("Open generated reports created from Populate.", present_panel)
                self.assertIn("These artifacts are stored only in this browser for the private demo.", present_panel)
                self.assertIn("Browser-local generated reports for presentation view", present_panel)
                self.assertNotIn("Clear local generated reports", present_panel)
                self.assertNotIn("Search", present_panel)
                self.assertNotIn("Filter", present_panel)
                self.assertNotIn("Version", present_panel)
                self.assertIn("Developer / QA tools", first_screen)
                self.assertIn("Clear local generated reports", first_screen)
