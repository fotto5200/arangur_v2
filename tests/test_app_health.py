    ...
    def test_root_page_returns_report_element_spec_composer(self) -> None:
        ...
        for path in ("/", "/app/", "/app/index.html"):
            with self.subTest(path=path):
                ...
                self.assertIn("Full dated report generation is not implemented yet. Use Preview from the builder for the current demo.", response.text)
                self.assertIn("Generated report presentation is a next workflow. For now, open a workflow and use Preview Client Briefing or Preview Advisor Review from the builder.", response.text)
                ...
                self.assertIn("Open, copy, or delete browser-local saved workflows from this list.", existing_panel)
