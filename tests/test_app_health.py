...
class AppHealthTests(unittest.TestCase):
    ...
    def test_root_page_returns_report_element_spec_composer(self) -> None:
        ...
        for path in ("/", "/app/", "/app/index.html"):
            with self.subTest(path=path):
                ...
                self.assertIn("Copy local set JSON", response.text)
                self.assertIn("Download local set JSON", response.text)
                self.assertIn("Print current Client Briefing Set", response.text)
                self.assertIn("Print current Advisor Review Set", response.text)
                self.assertIn("Download current Client Briefing Set HTML", response.text)
                self.assertIn("Download current Advisor Review Set HTML", response.text)
                self.assertIn("Copy current preview text", response.text)
                ...
                self.assertIn("Restore local spec set", response.text)
                self.assertIn('<details id="restore-spec-details" class="technical-details">', response.text)
                self.assertIn("Paste exported local set JSON", response.text)
                self.assertIn("Restore local set", response.text)
                self.assertIn("Backend save/load", response.text)
                self.assertIn("Save to backend", response.text)
                self.assertIn("Load saved sets", response.text)
                self.assertIn("Backend persistence is not configured. Use local export/download for now.", response.text)
                ...
                self.assertIn("Sample previews", response.text)
                ...
                self.assertIn("Current local preview", response.text)
                self.assertIn("No rendered preview available yet for this spec.", response.text)
                self.assertIn("has no elements yet.", response.text)
                self.assertIn("Add a report element first, then open this preview again before printing or exporting.", response.text)
                ...
                self.assertIn("Client-facing briefing sequence", response.text)
                self.assertIn("Advisor/internal review sequence", response.text)
                self.assertIn("Preview actions", response.text)
                ...
                self.assertNotIn("Print current Client Briefing Set", first_screen)
                self.assertNotIn("Download current Client Briefing Set HTML", first_screen)
                self.assertNotIn("Copy current preview text", first_screen)
    ...
    def test_browser_report_element_composer_fetches_catalog_and_preview_artifacts_only(self) -> None:
        ...
        self.assertNotIn(".json", first_screen)
        self.assertNotIn("Download current Client Briefing Set HTML", first_screen)
        self.assertNotIn("Download current Advisor Review Set HTML", first_screen)
        self.assertNotIn("Run workflow", response.text)
        self.assertIn("Search report elements", response.text)
        self.assertIn("Add element", response.text)
        self.assertIn("Browse all templates", response.text)
