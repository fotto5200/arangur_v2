    ...
    def test_root_page_returns_report_element_spec_composer(self) -> None:
        ...
        for path in ("/", "/app/", "/app/index.html"):
            with self.subTest(path=path):
                ...
                self.assertIn("Add at least one element before copying the local spec set.", response.text)
                self.assertIn("Add at least one element before downloading the local spec set.", response.text)
