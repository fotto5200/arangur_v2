    ...
    def test_root_page_returns_report_element_spec_composer(self) -> None:
        ...
        for path in ("/", "/app/", "/app/index.html"):
            with self.subTest(path=path):
                ...
                self.assertIn("Generated report presentation list is a next workflow.", response.text)
                ...
                self.assertIn("Generated report presentation list is a next workflow. Use Populate workflow with data to create and open a demo populated report for now.", response.text)
                ...
                self.assertIn("Generated report presentation list is a next workflow.", present_panel)
                self.assertIn("Use Populate workflow with data to create and open a demo populated report for now.", present_panel)
