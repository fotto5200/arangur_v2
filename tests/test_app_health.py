    ...
    def test_root_page_returns_report_element_spec_composer(self) -> None:
        ...
        for path in ("/", "/app/", "/app/index.html"):
            with self.subTest(path=path):
                ...
                self.assertIn("Design or edit briefing workflows", response.text)
                self.assertIn("Populate workflow with data", response.text)
                self.assertIn("Present or view reports", response.text)
                self.assertIn("New Client Briefing Workflow", response.text)
                self.assertIn("New Advisor Review Workflow", response.text)
                self.assertIn("Open saved workflow", response.text)
                self.assertIn("Copy existing workflow", response.text)
                self.assertIn("Named saved workflows", response.text)
                self.assertIn("Northstar Standard Quarterly Review", response.text)
                self.assertIn("Family Office Advisor Review Draft", response.text)
                self.assertIn("Q3 Client Briefing Draft", response.text)
                ...
                self.assertIn("Design or edit briefing workflows", first_screen)
                self.assertIn("Populate workflow with data", first_screen)
                self.assertIn("Present or view reports", first_screen)
                self.assertIn("New Client Briefing Workflow", first_screen)
                self.assertIn("New Advisor Review Workflow", first_screen)
                self.assertIn("Open saved workflow", first_screen)
                self.assertIn("Copy existing workflow", first_screen)
                self.assertIn("Named saved workflows", first_screen)
